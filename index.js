...
const glitchProjectUrl = 'https://equable-rapid-centaur.glitch.me/';
...
// Ping the Glitch project URL every 2 minutes (120,000 milliseconds)
setInterval(keepGlitchActive, 120000);
...
bot.on('message', async (msg) => {
    ...
    // Send "ok" response to confirm the bot is active
    ...
    if (youtubeUrlPattern.test(text)) {
        ...
        try {
            ...
            const apiSearchUrl = `https://tasteful-swamp-kale.glitch.me?name=${encodeURIComponent(text)}`;
